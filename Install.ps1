...
$script:ProfileJson = @'
{
  "tool_name": "SystemCleanup",
  "installer_title": "SystemCleanup Installer",
  "install_folder_name": "SystemCleanupContext",
  ...
  "registry_cleanup_keys": [
    ...
    "HKCU\\Software\\Classes\\Directory\\Background\\shell\\SystemTools\\shell\\22SystemCleanup",
    ...
    "HKCR\\Directory\\Background\\shell\\SystemTools\\shell\\22SystemCleanup",
    ...
    "HKCU\\Software\\Classes\\DesktopBackground\\Shell\\SystemTools\\shell\\22SystemCleanup",
    ...
    "HKCR\\DesktopBackground\\Shell\\SystemTools\\shell\\22SystemCleanup",
    "HKCR\\DesktopBackground\\Shell\\SystemTools\\shell\\AppsWindows\\shell\\SystemCleanup"
  ],
  "registry_values": [
    {
      "key": "HKCU\\Software\\Classes\\Directory\\Background\\shell\\SystemTools\\shell\\22SystemCleanup",
      "name": "MUIVerb",
      "type": "REG_SZ",
    ...
    {
      "key": "HKCU\\Software\\Classes\\Directory\\Background\\shell\\SystemTools\\shell\\22SystemCleanup\\Command",
      "name": "(default)",
      "type": "REG_SZ",
      "value": "wscript.exe \"{InstallRoot}\\Launch-SystemCleanup.vbs\""
    },
    {
      "key": "HKCU\\Software\\Classes\\DesktopBackground\\Shell\\SystemTools\\shell\\22SystemCleanup",
      "name": "MUIVerb",
      "type": "REG_SZ",
      "value": "Windows Update Cleanup"
    },
    ...
    {
      "key": "HKCU\\Software\\Classes\\DesktopBackground\\Shell\\SystemTools\\shell\\22SystemCleanup\\Command",
      "name": "(default)",
      "type": "REG_SZ",
      "value": "wscript.exe \"{InstallRoot}\\Launch-SystemCleanup.vbs\""
    }
